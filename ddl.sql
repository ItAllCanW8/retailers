...
(
    ...
    INDEX ` fk_locations_addresses_idx `
(
    `address_id` ASC
) VISIBLE,
...
(
    ...
    INDEX ` fk_user_address_idx `
(
    `address_id` ASC
) VISIBLE,
    INDEX ` fk_user_location_idx `
(
    `location_id` ASC
) VISIBLE,
    INDEX ` fk_user_role `
...
(
    ...
    INDEX ` fk_application_created_by_idx `
(
    `created_by` ASC
) VISIBLE,
    INDEX ` fk_application_upd_by_idx `
(
    `last_upd_by` ASC
) VISIBLE,
    INDEX ` fk_application_src_location_idx `
(
    `source_location` ASC
) VISIBLE,
    INDEX ` fk_application_dest_location_idx `
(
...
(
    ...
    INDEX ` fk_application_item_application_idx `
(
    `application_id` ASC
) VISIBLE,
...
(
    ...
    REFERENCES ` retailers `.` application `
(
    `id`
),
...
(
    ...
    INDEX ` fk_bills_users_idx `
(
    `shop_manager` ASC
) VISIBLE,
    INDEX ` fk_bill_location_idx `
(
    `location_id` ASC
) VISIBLE,
...
(
    ...
    INDEX ` fk_customer_category_customer_idx `
(
    `customer_id` ASC
) VISIBLE,
    INDEX ` fk_customer_category_category_idx `
(
    `category_id` ASC
) VISIBLE,
...
(
    ...
    INDEX ` fk_customer_employee_customer_idx `
(
    `customer_id` ASC
) VISIBLE,
    INDEX ` fk_customer_employee_user_idx `
(
    `employee_id` ASC
) VISIBLE,
...
(
    ...
    INDEX ` fk_customer_location_customer_idx `
(
    `customer_id` ASC
) VISIBLE,
    INDEX ` fk_customer_location_location_idx `
(
    `location_id` ASC
) VISIBLE,
...
(
    ...
    INDEX ` fk_customer_location_item_customer_location_idx `
(
    `customer_location` ASC
) VISIBLE,
    INDEX ` fk_customer_location_item_item `
(
    `item` ASC
) VISIBLE,
...
(
    ...
    REFERENCES ` retailers `.` customer_location `
(
    `id`
),
...
(
    ...
    UNIQUE INDEX ` shop_id_fk_UNIQUE `
(
    `location_id` ASC
) VISIBLE,
    INDEX ` fk_location_tax_location_idx `
(
    `location_id` ASC
) VISIBLE,
...
(
    ...
    UNIQUE INDEX ` state_code_UNIQUE `
(
    `state_code` ASC
) VISIBLE)
    ENGINE = InnoDB
...
(
    ...
    UNIQUE INDEX ` identifier_UNIQUE `
(
    `id` ASC
) VISIBLE)
    ENGINE = InnoDB
...
(
    ...
    INDEX ` fk_supplier_warehouse_supplier_idx `
(
    `supplier_id` ASC
) VISIBLE,
    INDEX ` fk_supplier_warehouse_warehouse_idx `
(
    `warehouse_id` ASC
) VISIBLE,
...
(
    ...
    INDEX ` fk_write_off_act_location_idx `
(
    `location_id` ASC
) VISIBLE,
...
(
    ...
    INDEX ` fk_write_off_item_write_off_idx `
(
    `write_off_id` ASC
) VISIBLE,
...
(
    ...
    REFERENCES ` retailers `.` write_off_act `
(
    `id`
))
    ENGINE = InnoDB
