...
public class AdminServiceImpl implements AdminService {
    ...
    public User createUser(User user)
        ...
        new PasswordEmailSender(user.getEmail(), generatedPassword, mailService).start();
        ...
        LOGGER.warn(String.format(LOG_CREATED_MSG, USER_LABEL, user.getName()));
    ...
    public void updateUserStatus(Long id, boolean isActive) {
        ...
        LOGGER.warn(String.format(LOG_UPDATED_MSG, USER_LABEL, id));
    }
    ...
    public Supplier createSupplier(Supplier supplier) {
        ...
        LOGGER.warn(String.format(LOG_CREATED_MSG, SUPPLIER_LABEL, supplier.getIdentifier()));
        return supplier;
    }
    ...
    public void updateSupplierStatus(Long id, boolean isActive) {
        ...
        LOGGER.warn(String.format(LOG_UPDATED_MSG, SUPPLIER_LABEL, id));
    }
}
